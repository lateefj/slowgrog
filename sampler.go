...
func SampleInfo(c redis.Conn, status *Status) (string, error) {
...
func SampleSlowlog(c redis.Conn, status *Status) (string, error) {
  Trace.Println("Sampling slowlog...")
...
func SampleMonitor(c redis.Conn, status *Status) {
